        ...
        with io.BufferedReader(gzip.GzipFile(filename=os.path.basename(file_path),
            ...
            for medline_record in reader.retrieve_medline_record(f):
                ...
                if pmid == '25053090':
                    ...
                    # authors = [{'full_name': 'Taira Junsei', 'short_name': 'Taira J', 'LastName': 'Taira'}, {'LastName': 'Tsuchida', 'short_name': 'Tsuchida E', 'full_name': 'Tsuchida Eito'}, {'LastName': 'Katoh', 'short_name': 'Katoh MC', 'full_name': 'Katoh Megumi C'}, {'LastName': 'Uehara', 'short_name': 'Uehara M', 'full_name': 'Masatsugu'}, {'LastName': 'Ogi', 'short_name': 'T', 'full_name': 'Ogi Takayuki'}]
